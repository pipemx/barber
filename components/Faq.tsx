...
function FaqItem({ q, a, index }: { q: string; a: string; index: number }) {
  ...
  return (
    <Reveal delay={index * 0.05}>
      <div className="bg-surface border border-line rounded-2xl overflow-hidden hover:border-gold/30 transition-colors duration-300">
        <button
        ...
        >
          ...
          <motion.span
            ...
            className="shrink-0 w-8 h-8 rounded-full bg-gold/10 border border-gold/25 flex items-center justify-center"
          >
    ...
    <section className="relative py-24 md:py-32 px-5 md:px-8 section-glow">
      <div className="mx-auto max-w-3xl">
        <SectionHeading
          ...
          title={
            <>
              Todo lo que necesitas <span className="text-gold-gradient italic">saber</span>
            </>
          }
        />
