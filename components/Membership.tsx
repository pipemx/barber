...
import { GoldButton, Reveal, SectionHeading, WhatsAppIcon } from "./ui";
...
export function Membership() {
  ...
  return (
    ...
    >
      <div className="ambient-glow w-[500px] h-[500px] bg-gold/12 top-1/4 left-1/2 -translate-x-1/2" />
      <div className="mx-auto max-w-4xl relative">
        <SectionHeading
          kicker="VIP Club"
          title={
            <>
              Únete al círculo <span className="text-gold-gradient italic">interior</span>
            </>
          }
          subtitle="Para el hombre que no deja su imagen al azar. Cupo limitado a 100 miembros activos."
        />
        <Reveal>
          <div className="relative glass rounded-3xl border border-gold/30 p-8 md:p-12 shadow-glow-gold">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 pt-4">
              <div>
                <div className="flex items-baseline gap-3">
                  <span className="font-display text-5xl md:text-6xl text-gold-gradient tabular-nums">
                    ${membership.price}
                  </span>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <GoldButton href={waLink(waMessages.membership)} className="w-full sm:w-auto">
