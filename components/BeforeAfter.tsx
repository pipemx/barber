    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-6 right-6 text-right">
          <p className="font-display text-2xl md:text-3xl text-gold-bright italic">Después</p>
          <p className="text-xs md:text-sm text-stone-muted mt-1 uppercase tracking-widest">
            Fade Premium · Marco Delgado
          </p>
        </div>
      </div>
      ...
      {/* Divisor */}
      <div
        className="absolute top-0 bottom-0 w-0.5 bg-gold shadow-glow-gold"
        style={{ left: `${pos}%` }}
      >
    ...
    <section className="relative py-24 md:py-32 px-5 md:px-8 bg-ink-soft border-y border-line">
      <div className="mx-auto max-w-5xl">
        <SectionHeading
          ...
          title={
            <>
              El espejo <span className="text-gold-gradient italic">no miente</span>
            </>
          }
